...
function Agent() {
  ...
  const logoFn = (type: string) => {
    switch (type) {
      case 'workflow':
        return '/datainsights-service/pictures/flow.png';
      case 'resources':
        return '/datainsights-service/pictures/database.png';
      case 'apps':
        return '/datainsights-service/pictures/app.png';
      case 'operators':
        return '/datainsights-service/pictures/knowledge.png';
      case 'agents':
      default:
        return '/datainsights-service/pictures/agent.png';
    }
  };
