...
export default function AppContent() {
  ...
  // Distinguish whether to click or double click
  ...
  // Get the application permission list
  ...
  // Click Copy to share DingTalk link
  const shareDingding = (item: IApp) => {
    ...
    const timeoutId = setTimeout(() => {
      ...
      setClickTimeout(null);
    }, 300); // Double-click time interval
    setClickTimeout(timeoutId as any);
  };

  // Double-click to open the nail
    ...
    <ConstructLayout>
      ...
      <Modal title='Permission Management' open={adminOpen} onCancel={() => setAdminOpen(false)} footer={null}>
        <Spin spinning={loading}>
          <div className='py-4'>
            <div className='mb-1'>administrator（Work number，Deprefix0）：</div>
            <Select
              mode='tags'
              value={admins}
              style={{ width: '100%' }}
