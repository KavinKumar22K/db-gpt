...
const InputContainer: React.FC = () => {
  ...
  // Whether to displayRecommended questions
  const showRecommendQuestion = useMemo(() => {
    // Only show when there is no dialogue
  ...
  // ifurlcarryquesquestion，Ask a question directly
  useEffect(() => {
    ...
    <div className='flex flex-col'>
      ...
      <div className='flex items-center justify-between gap-1'>
        ...
        <div className='flex items-center justify-between text-lg font-bold'>
          ...
          <Popover content='Do it again' trigger={['hover']}>
            <RedoOutlined
              className={classnames('p-2 cursor-pointer', {
      ...
      >
        <Input.TextArea
          placeholder='Can ask me any questions'
