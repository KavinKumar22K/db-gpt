            ...
            label: (
              <div className='py-1 flex justify-between gap-8 '>
                <span className='flex gap-2 items-center'>
                  <Image
                    src='/datainsights-service/pictures/theme_light.png'
                    alt='english'
                    width={38}
                    height={32}
                  ></Image>
          ...
          },
          {
            ...
            label: (
              <div className='py-1 flex justify-between gap-8 '>
                <span className='flex gap-2 items-center'>
                  <Image
                    src='/datainsights-service/pictures/theme_dark.png'
                    alt='english'
                    width={38}
                    height={32}
                  ></Image>
    ...
    const items: RouteItem[] = [
      {
        ...
        icon: (
          <Image
            ...
            src={
              pathname === '/'
                ? '/datainsights-service/pictures/explore_active.png'
                : '/datainsights-service/pictures/explore.png'
            }
            alt='construct_image'
            width={40}
            height={40}
      ...
      },
      {
        ...
        icon: (
          <Image
            ...
            src={
              pathname === '/chat'
                ? '/datainsights-service/pictures/chat_active.png'
                : '/datainsights-service/pictures/chat.png'
            }
            alt='chat_image'
            width={40}
            height={40}
